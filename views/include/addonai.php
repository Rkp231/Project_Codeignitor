    ...
    <div class="row">
      <div class="col">
        ...
        <ul>
          ...
          <li class="last_breadcrumb">Cloud Computing & Artificial Intelligence</li>
      ...
      <div class="col-lg-12 col-md-12">
        <div class="news-item bxw">
          <div class="news-item-img">
            <img src="assets/img/courseimg/ss.jpg" alt="">
			<img src="https://ebenezercollege.edu.in/assets/img/courseimg/addonimg/EMailer_Coding-1.png" alt="">
          ...
          <!--<div class="news-item-content">
            ...
            <center>  <h3>Cloud Computing & Artificial Intelligence</h3><br></center>
            </a>

            <p>Artificial intelligence capabilities are now layering with cloud computing and helping companies manage their data, look for patterns and insights in information, deliver customer experiences, and optimize workflows. AI and data science are interwoven.</p><hr>

<div class="row">
<div class="col-lg-6 col-md-6">
            <h3>Course structure:</h3>
            <li> Industry Visit/ IT Fairs/ IT Seminar/ IT park visits</li>
