              ...
              <div class="table-responsive">
                <table id="basic-datatables" class="display table table-striped table-hover" >
                  ...
                  <tbody>
                    ...
                    <?php
                     $listdownloadbroucherslist = $this->msuperadmin->listdownloadbroucherslistbystatus(2);
                     $i=1;
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('superadmin/broucherdownloadsts/'.$bid.'/1/listformbroucherdownloadslead') ?>" class="btn btn-warning btn-xs ">New</a>
                        <a href="<?php echo site_url('superadmin/broucherdownloadsts/'.$bid.'/3/listformbroucherdownloadslead') ?>" class="btn btn-danger btn-xs">Delete</a>
