              ...
              <div class="table-responsive">
                <table id="basic-datatables" class="display table table-striped table-hover" >
                  ...
                  <tbody>
                    ...
                    <?php
                     $listdownloadbroucherslist = $this->msuperadmin->listdownloadbroucherslistbystatus(1);
                     $i=1;
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('superadmin/broucherdownloadsts/'.$bid.'/2/listformbroucherdownloadsnew') ?>" class="btn btn-success btn-xs ">Lead</a>
                        <a href="<?php echo site_url('superadmin/broucherdownloadsts/'.$bid.'/3/listformbroucherdownloadsnew') ?>" class="btn btn-danger btn-xs">Delete</a>
