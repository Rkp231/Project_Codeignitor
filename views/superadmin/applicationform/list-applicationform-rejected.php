              ...
              <div class="table-responsive">
                <table id="basic-datatables" class="display table table-striped table-hover" >
                  ...
                  <tbody>
                     ...
                     <?php
                      $listapplicationformlist = $this->msuperadmin->listapplicationformlistbystatus(3);
                       $i=1;
                    ...
                    <tr>
                      ...
                      <td>
                        <a href="<?php echo site_url('superadmin/applicationformsts/'.$applicationid.'/1/listformrejected') ?>" class="btn btn-warning btn-xs ">New</a>
                        <a href="<?php echo site_url('superadmin/applicationformsts/'.$applicationid.'/2/listformrejected') ?>" class="btn btn-success btn-xs">Select</a>
