              ...
              <div class="table-responsive">
                <table id="basic-datatables" class="display table table-striped table-hover" >
                  ...
                  <tbody>
                     ...
                     <?php
                      $listapplicationformlist = $this->msuperadmin->listapplicationformlistbystatus(1);
                       $i=1;
                    ...
                    <tr>
                      ...
                      <td><?php if($status==1){ ?>
                        ...
                        <?php } else if($status==2) { ?>
                          <button class="btn-round btn-success btn-xs">Select</button>
                        <?php } else if($status==3) { ?>
                          <button class="btn-round btn-danger btn-xs">Reject</button>
                        <?php } ?>
                      </td>
                      <td>
                        <a href="<?php echo site_url('superadmin/applicationformsts/'.$applicationid.'/2/listformnew') ?>" class="btn btn-success btn-xs ">Select</a>
                        <a href="<?php echo site_url('superadmin/applicationformsts/'.$applicationid.'/3/listformnew') ?>" class="btn btn-danger btn-xs">Reject</a>
